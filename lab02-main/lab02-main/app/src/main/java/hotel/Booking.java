...
public class Booking {
    ...
    */
    ...
    public boolean overlaps(LocalDate start, LocalDate end) {
        return (start.isBefore(this.departure) && end.isAfter(this.arrival))
                || (end.isAfter(this.arrival) && start.isBefore(this.departure))
                || (start.isBefore(this.arrival) && end.isAfter(this.departure));
    }
