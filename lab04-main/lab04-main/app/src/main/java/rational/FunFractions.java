...
public class FunFractions {
    ...
    //         "+", "-", "×", "÷"
    // };
    // private static final ArrayList<String> NUMERICS = new ArrayList<String>(Arrays.asList(new String[] {
    //         "1", "2", "3", "4", "5", "6", "7", "8", "9", "0"
    // }));
    ...
    //         List<Rational> answers = new ArrayList<Rational>(Arrays.asList(new Rational[] {
    //                 answer, randomRational(), randomRational(), randomRational()
    //         }));
