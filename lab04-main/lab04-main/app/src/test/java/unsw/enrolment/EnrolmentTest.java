...
public class EnrolmentTest {
    ...
    public void testComparator() throws InvalidEnrolmentException {
        ...
        Course cs2511 = new Course("COMP2511", "OOP");
        CourseOffering cs2511Offering = new CourseOffering(cs2511, "24T2");
        Student student1 = new Student("z51234567", "c", 3707, new String[] {"a"});
        Student student2 = new Student("z51234567", "b", 3707, new String[] {"b"});
        Student student3 = new Student("z51234567", "a", 3707, new String[] {"c"});
        cs2511Offering.addEnrolment(student1);
        cs2511Offering.addEnrolment(student2);
        cs2511Offering.addEnrolment(student3);
        List<Student> students = new ArrayList<>();
        students.add(student3);
        students.add(student2);
        students.add(student1);
        assertEquals(students, cs2511Offering.studentsEnrolledInCourse());
    }
}
