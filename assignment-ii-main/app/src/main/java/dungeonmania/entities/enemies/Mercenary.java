...
public class Mercenary extends Enemy implements Interactable {
    ...
    private int mindControlDurationCurrent = -1;
    ...
    private void bribe(Player player) {
        if (player.hasSceptre()) {
            mindControlDurationCurrent = mindControlDuration;
            return;
        }
    ...
    public void makeMercenaryMindControl() {
        if (mindControlDurationCurrent > 0) {
            mindControlDurationCurrent--;
            return;
        } else if (mindControlDurationCurrent == -1) {
            return;
        }

        mindControlDurationCurrent = -1;
        allied = false;
    }
}
